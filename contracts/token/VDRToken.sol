...
contract VDRToken is ERC20Capped, Ownable {
    ...
    constructor() ERC20Capped(MAX_SUPPLY) ERC20("VDR", "VDR") {
        ...
        external
    {
        ...
        require(signatory != address(0), "VDR::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "VDR::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "VDR::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "VDR::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying VDRs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "VDR::_writeCheckpoint: block number exceeds 32 bits");
